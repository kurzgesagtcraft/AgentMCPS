...
const apiConfig = require('./modules/apiConfig.js');
...
const apiKey = apiConfig.chat.apiKey;
const apiUrl = apiConfig.chat.apiUrl;
const serverKey = apiConfig.memory.vcpServerKey;
